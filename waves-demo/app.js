...
var _user$project$Main$applyDrag = F2(
	function (_p0, param) {
		var _p1 = _p0;
		var f = F3(
			function (_p2, start, current) {
				var _p3 = _p2;
				return {
					ctor: '_Tuple2',
					_0: _p3._0 + _elm_lang$core$Basics$toFloat(current.x - start.x),
					_1: _p3._1 + _elm_lang$core$Basics$toFloat(current.y - start.y)
				};
			});
		var xy = A3(f, _p1.handleOrigin, _p1.start, _p1.current);
		return A2(_p1.lens.set, xy, param);
	});
...
var _user$project$Main$addDelta = F3(
	function (_p6, s, _p5) {
		var _p7 = _p6;
		var _p8 = _p5;
		return {ctor: '_Tuple2', _0: _p7._0 + (s * _p8._0), _1: _p7._1 + (s * _p8._1)};
	});
var _user$project$Main$wave = F4(
	function (endPoint1, controlPoint1, controlPoint2, endPoint2) {
		var pathSpec = _folkertdev$svg_path_lowlevel$Path_LowLevel$toString(
			{
				ctor: '::',
				_0: {
					moveto: A2(_folkertdev$svg_path_lowlevel$Path_LowLevel$MoveTo, _folkertdev$svg_path_lowlevel$Path_LowLevel$Absolute, endPoint1),
					drawtos: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: {ctor: '_Tuple3', _0: controlPoint1, _1: controlPoint2, _2: endPoint2},
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$d(pathSpec),
				_1: {
					ctor: '::',
...
var _user$project$Main$init = function () {
	var model = {
		param: {
			topControlPoint1: {ctor: '_Tuple2', _0: 559.0, _1: 261.0},
			topControlPoint2: {ctor: '_Tuple2', _0: 606.0, _1: 84.0},
			topEndpointPoint2: {ctor: '_Tuple2', _0: 677.0, _1: 185.0},
			topEndPoint1dy: 25,
...
var _user$project$Main$Lens = F2(
	function (a, b) {
		return {get: a, set: b};
	});
var _user$project$Main$Parameter = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
															...
															return function (p) {
																return function (q) {
																	return function (r) {
																		return function (s) {
																			return function (t) {
																				return {topControlPoint1: a, topControlPoint2: b, topEndpointPoint2: c, topEndPoint1dy: d, topControlPoint1dy: e, topControlPoint1dx: f, topControlPoint2dy: g, topControlPoint2dx: h, topEndPoint2dx: i, topEndPoint2dy: j, bottomEndPoint1: k, bottomControlPoint1: l, bottomControlPoint2: m, bottomEndPoint1dx: n, bottomEndPoint1dy: o, bottomControlPoint1dy: p, bottomControlPoint1dx: q, bottomControlPoint2dy: r, bottomControlPoint2dx: s, bottomEndPoint2dy: t};
																			};
																		};
																	};
																};
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {param: a, drag: b, showHandles: c};
	});
var _user$project$Main$Drag = F4(
	function (a, b, c, d) {
		return {lens: a, handleOrigin: b, start: c, current: d};
	});
	...
	function (msg, model) {
		...
		switch (_p9.ctor) {
			case 'DragStart':
				var _p11 = _p9._1;
				var _p10 = _p9._0;
				var handleOrigin = _p10.get(model.param);
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						drag: _elm_lang$core$Maybe$Just(
							A4(_user$project$Main$Drag, _p10, handleOrigin, _p11, _p11))
					});
			case 'DragAt':
				var _p12 = model.drag;
						...
						model,
						{
							drag: _elm_lang$core$Maybe$Just(
								_elm_lang$core$Native_Utils.update(
									_p13,
									{current: _p9._0})),
							param: A2(_user$project$Main$applyDrag, _p13, model.param)
						});
				}
			case 'DragEnd':
				return _elm_lang$core$Native_Utils.update(
					...
					{drag: _elm_lang$core$Maybe$Nothing});
			case 'SliderUpdate':
				var param2 = A2(_p9._0.set, _p9._1, model.param);
				return _elm_lang$core$Native_Utils.update(
					model,
					{param: param2});
			default:
...
var _user$project$Main$SliderSpec = F4(
	function (a, b, c, d) {
		return {min: a, max: b, step: c, name: d};
	});
var _user$project$Main$ToggleHandles = {ctor: 'ToggleHandles'};
var _user$project$Main$SliderUpdate = F2(
	function (a, b) {
		return {ctor: 'SliderUpdate', _0: a, _1: b};
	});
var _user$project$Main$sliderView = F3(
	function (sliderSpec, lens, param) {
		var value = lens.get(param);
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(sliderSpec.name),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
						...
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Attributes$min(
									_elm_lang$core$Basics$toString(sliderSpec.min)),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$max(
										_elm_lang$core$Basics$toString(sliderSpec.max)),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$step(
											_elm_lang$core$Basics$toString(sliderSpec.step)),
										_1: {
											ctor: '::',
											...
											_1: {
												...
												_0: _elm_lang$html$Html_Events$onInput(
													function (s) {
														return A2(
															_user$project$Main$SliderUpdate,
															lens,
															A2(
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('control-value'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _user$project$Main$topControls = function (param) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			ctor: '::',
			_0: A3(
				_user$project$Main$sliderView,
				{min: 5, max: 50, step: 1, name: 'topEndPoint1dy'},
				A2(
					_user$project$Main$Lens,
					function (param) {
						return param.topEndPoint1dy;
					},
					F2(
						function (value, param) {
							return _elm_lang$core$Native_Utils.update(
								param,
								{topEndPoint1dy: value});
						})),
				param),
			_1: {
				ctor: '::',
				_0: A3(
					_user$project$Main$sliderView,
					{min: -50, max: 50, step: 1, name: 'topControlPoint1dx'},
					A2(
						_user$project$Main$Lens,
						function (param) {
							return param.topControlPoint1dx;
						},
						F2(
							function (value, param) {
								return _elm_lang$core$Native_Utils.update(
									param,
									{topControlPoint1dx: value});
							})),
					param),
				_1: {
					ctor: '::',
					_0: A3(
						_user$project$Main$sliderView,
						{min: 5, max: 50, step: 1, name: 'topControlPoint1dy'},
						A2(
							_user$project$Main$Lens,
							function (param) {
								return param.topControlPoint1dy;
							},
							F2(
								function (value, param) {
									return _elm_lang$core$Native_Utils.update(
										param,
										{topControlPoint1dy: value});
								})),
						param),
					_1: {
						ctor: '::',
						_0: A3(
							_user$project$Main$sliderView,
							{min: -50, max: 50, step: 1, name: 'topControlPoint2dx'},
							A2(
								_user$project$Main$Lens,
								function (param) {
									return param.topControlPoint2dx;
								},
								F2(
									function (value, param) {
										return _elm_lang$core$Native_Utils.update(
											param,
											{topControlPoint2dx: value});
									})),
							param),
						_1: {
							ctor: '::',
							_0: A3(
								_user$project$Main$sliderView,
								{min: 5, max: 50, step: 1, name: 'topControlPoint2dy'},
								A2(
									_user$project$Main$Lens,
									function (param) {
										return param.topControlPoint2dy;
									},
									F2(
										function (value, param) {
											return _elm_lang$core$Native_Utils.update(
												param,
												{topControlPoint2dy: value});
										})),
								param),
							_1: {
								ctor: '::',
								_0: A3(
									_user$project$Main$sliderView,
									{min: -50, max: 50, step: 1, name: 'topEndPoint2dx'},
									A2(
										_user$project$Main$Lens,
										function (param) {
											return param.topEndPoint2dx;
										},
										F2(
											function (value, param) {
												return _elm_lang$core$Native_Utils.update(
													param,
													{topEndPoint2dx: value});
											})),
									param),
								_1: {
									ctor: '::',
									_0: A3(
										_user$project$Main$sliderView,
										{min: 5, max: 50, step: 1, name: 'topEndPoint2dy'},
										A2(
											_user$project$Main$Lens,
											function (param) {
												return param.topEndPoint2dy;
											},
											F2(
												function (value, param) {
													return _elm_lang$core$Native_Utils.update(
														param,
														{topEndPoint2dy: value});
												})),
										param),
									_1: {ctor: '[]'}
								}
...
var _user$project$Main$bottomControls = function (param) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A3(
				_user$project$Main$sliderView,
				{min: -50, max: 50, step: 1, name: 'bottomEndPoint1dx'},
				A2(
					_user$project$Main$Lens,
					function (param) {
						return param.bottomEndPoint1dx;
					},
					F2(
						function (value, param) {
							return _elm_lang$core$Native_Utils.update(
								param,
								{bottomEndPoint1dx: value});
						})),
				param),
			_1: {
				ctor: '::',
				_0: A3(
					_user$project$Main$sliderView,
					{min: 5, max: 50, step: 1, name: 'bottomEndPoint1dy'},
					A2(
						_user$project$Main$Lens,
						function (param) {
							return param.bottomEndPoint1dy;
						},
						F2(
							function (value, param) {
								return _elm_lang$core$Native_Utils.update(
									param,
									{bottomEndPoint1dy: value});
							})),
					param),
				_1: {
					ctor: '::',
					_0: A3(
						_user$project$Main$sliderView,
						{min: -50, max: 50, step: 1, name: 'bottomControlPoint1dx'},
						A2(
							_user$project$Main$Lens,
							function (param) {
								return param.bottomControlPoint1dx;
							},
							F2(
								function (value, param) {
									return _elm_lang$core$Native_Utils.update(
										param,
										{bottomControlPoint1dx: value});
								})),
						param),
					_1: {
						ctor: '::',
						_0: A3(
							_user$project$Main$sliderView,
							{min: 5, max: 50, step: 1, name: 'bottomControlPoint1dy'},
							A2(
								_user$project$Main$Lens,
								function (param) {
									return param.bottomControlPoint1dy;
								},
								F2(
									function (value, param) {
										return _elm_lang$core$Native_Utils.update(
											param,
											{bottomControlPoint1dy: value});
									})),
							param),
						_1: {
							ctor: '::',
							_0: A3(
								_user$project$Main$sliderView,
								{min: -50, max: 50, step: 1, name: 'bottomControlPoint2dx'},
								A2(
									_user$project$Main$Lens,
									function (param) {
										return param.bottomControlPoint2dx;
									},
									F2(
										function (value, param) {
											return _elm_lang$core$Native_Utils.update(
												param,
												{bottomControlPoint2dx: value});
										})),
								param),
							_1: {
								ctor: '::',
								_0: A3(
									_user$project$Main$sliderView,
									{min: 5, max: 50, step: 1, name: 'bottomControlPoint2dy'},
									A2(
										_user$project$Main$Lens,
										function (param) {
											return param.bottomControlPoint2dy;
										},
										F2(
											function (value, param) {
												return _elm_lang$core$Native_Utils.update(
													param,
													{bottomControlPoint2dy: value});
											})),
									param),
								_1: {
									ctor: '::',
									_0: A3(
										_user$project$Main$sliderView,
										{min: 5, max: 50, step: 1, name: 'bottomEndPoint2dy'},
										A2(
											_user$project$Main$Lens,
											function (param) {
												return param.bottomEndPoint2dy;
											},
											F2(
												function (value, param) {
													return _elm_lang$core$Native_Utils.update(
														param,
														{bottomEndPoint2dy: value});
												})),
										param),
									_1: {ctor: '[]'}
								}
...
var _user$project$Main$curveHandle = F2(
	function (lens, param) {
		var onMouseDown = function () {
			...
			return A3(
				...
				A2(
					_elm_lang$core$Json_Decode$map,
					_user$project$Main$DragStart(lens),
					_elm_lang$mouse$Mouse$position));
		}();
		var _p15 = lens.get(param);
		var pointX = _p15._0;
		var pointY = _p15._1;
		var w = 7;
		return A2(
			_elm_lang$svg$Svg$circle,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$cx(
					_elm_lang$core$Basics$toString(pointX)),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$cy(
						_elm_lang$core$Basics$toString(pointY)),
					_1: {
						ctor: '::',
...
var _user$project$Main$waves = function (_p16) {
	var _p17 = _p16;
	var _p18 = _p17.param;
	var bottomHandles = {
		ctor: '::',
		_0: A2(
			_user$project$Main$curveHandle,
			A2(
				_user$project$Main$Lens,
				function (param) {
					return param.bottomEndPoint1;
				},
				F2(
					function (xy, param) {
						return _elm_lang$core$Native_Utils.update(
		...
		_1: {
			...
			_0: A2(
				...
				A2(
					_user$project$Main$Lens,
					function (param) {
						return param.bottomControlPoint1;
					},
					F2(
						function (xy, param) {
							return _elm_lang$core$Native_Utils.update(
								param,
								{bottomControlPoint1: xy});
						})),
				_p18),
			_1: {
				ctor: '::',
				_0: A2(
					...
					A2(
						_user$project$Main$Lens,
						function (param) {
							return param.bottomControlPoint2;
						},
						F2(
							function (xy, param) {
								return _elm_lang$core$Native_Utils.update(
									param,
									{bottomControlPoint2: xy});
							})),
					_p18),
				_1: {ctor: '[]'}
			}
		...
		_1: {
			...
			_0: A2(
				...
				A2(
					_user$project$Main$Lens,
					function (param) {
						return param.topEndpointPoint2;
					},
					F2(
						function (xy, param) {
							return _elm_lang$core$Native_Utils.update(
								param,
								{topEndpointPoint2: xy});
						})),
				_p18),
			_1: {
				ctor: '::',
	...
	var handles = (_p17.showHandles && _user$project$Main$isNothing(_p17.drag)) ? A2(_elm_lang$core$Basics_ops['++'], topHandles, bottomHandles) : {ctor: '[]'};
	var range = A2(
		_elm_lang$core$List$map,
		function (i) {
			return _elm_lang$core$Basics$toFloat(i);
		},
	...
	var topWaves = A2(
		...
		function (i) {
			return A4(
				_user$project$Main$wave,
				A3(
					_user$project$Main$addDelta,
					{ctor: '_Tuple2', _0: 0, _1: 250},
					i,
					{ctor: '_Tuple2', _0: 0.0, _1: _p18.topEndPoint1dy}),
				A3(
					_user$project$Main$addDelta,
					_p18.topControlPoint1,
					i,
					{ctor: '_Tuple2', _0: _p18.topControlPoint1dx, _1: _p18.topControlPoint1dy}),
				A3(
					_user$project$Main$addDelta,
					_p18.topControlPoint2,
					i,
					{ctor: '_Tuple2', _0: _p18.topControlPoint2dx, _1: _p18.topControlPoint2dy}),
				A3(
					_user$project$Main$addDelta,
					_p18.topEndpointPoint2,
					i,
					{ctor: '_Tuple2', _0: _p18.topEndPoint2dx, _1: _p18.topEndPoint2dy}));
		},
		range);
	var bottomWaves = A2(
		_elm_lang$core$List$map,
		function (i) {
			return A4(
				...
				A3(
					_user$project$Main$addDelta,
					_p18.bottomEndPoint1,
					i,
					{ctor: '_Tuple2', _0: _p18.bottomEndPoint1dx, _1: _p18.bottomEndPoint1dy}),
				A3(
					_user$project$Main$addDelta,
					_p18.bottomControlPoint1,
					i,
					{ctor: '_Tuple2', _0: _p18.bottomControlPoint1dx, _1: _p18.bottomControlPoint1dy}),
				A3(
					_user$project$Main$addDelta,
					_p18.bottomControlPoint2,
					i,
					{ctor: '_Tuple2', _0: _p18.bottomControlPoint2dx, _1: _p18.bottomControlPoint2dy}),
				A3(
					_user$project$Main$addDelta,
					{ctor: '_Tuple2', _0: 1200, _1: 250},
					i,
					{ctor: '_Tuple2', _0: 0.0, _1: _p18.bottomEndPoint2dy}));
		},
		range);
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$id('wave-svg'),
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$viewBox('0 0 1200 500'),
						_1: {ctor: '[]'}
					}
				}
			}
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			topWaves,
			A2(_elm_lang$core$Basics_ops['++'], bottomWaves, handles)));
};
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$waves(model),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Main$checkbox, _user$project$Main$ToggleHandles, 'toggle handles'),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						...
						{
							ctor: '::',
							_0: _user$project$Main$topControls(model.param),
							_1: {
								ctor: '::',
								_0: _user$project$Main$bottomControls(model.param),
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
